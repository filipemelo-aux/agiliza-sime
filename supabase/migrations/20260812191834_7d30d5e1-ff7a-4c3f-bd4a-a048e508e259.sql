CREATE OR REPLACE FUNCTION public.save_credit_card_invoice_edit(
  _invoice_id uuid,
  _invoice jsonb,
  _items jsonb
)
...
REVOKE ALL ON FUNCTION public.save_credit_card_invoice_edit(uuid, jsonb, jsonb) FROM PUBLIC;
