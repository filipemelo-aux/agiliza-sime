...
function formToPayload(form: FormState) {
  ...
  return {
    ...
    // PF (clientes/fornecedores) guardam o CPF na mesma coluna do documento.
    cnpj: isMotorista || isColaborador ? null : form.person_type === "cnpj" ? unmaskCNPJ(form.cnpj) || null : unmaskCPF(form.cpf) || null,
