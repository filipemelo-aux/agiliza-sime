                  ...
                  >
                    <thead className="sticky top-0 z-10 bg-muted/60">
                      <tr className="border-b border-border">
                        <SortableTh data-column-key="tr_data" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground whitespace-nowrap" active={sort.key === "data"} direction={sort.direction} onSort={() => toggle("data")}>Data</SortableTh>
                        <SortableTh data-column-key="tr_numero" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground whitespace-nowrap" active={sort.key === "titulo"} direction={sort.direction} onSort={() => toggle("titulo")}>{numeroLabel}</SortableTh>
                        {showProduto && <th data-column-key="tr_produto" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground whitespace-nowrap">Produto</th>}
                        <SortableTh data-column-key="tr_pessoa" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground whitespace-nowrap" active={sort.key === "pessoa"} direction={sort.direction} onSort={() => toggle("pessoa")}>Pessoa</SortableTh>
                        <SortableTh data-column-key="tr_rota" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground whitespace-nowrap" active={sort.key === "rota"} direction={sort.direction} onSort={() => toggle("rota")}>Origem → Destino</SortableTh>
                        <SortableTh data-column-key="tr_veiculo" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground whitespace-nowrap" active={sort.key === "veiculo"} direction={sort.direction} onSort={() => toggle("veiculo")}>Veículo</SortableTh>
                        <th data-column-key="tr_proprietario" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground whitespace-nowrap">Proprietário</th>
                        {showPeso && <th data-column-key="tr_peso" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground text-right whitespace-nowrap">Peso (t)</th>}
                        {showLitros && <th data-column-key="tr_litros" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground text-right whitespace-nowrap">Litros</th>}
                        {showDesconto && <th data-column-key="tr_desconto" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground text-right whitespace-nowrap">Desconto</th>}
                        {showValor && <SortableTh data-column-key="tr_valor" align="right" className="px-1.5 py-1.5 font-semibold text-[10px] uppercase text-muted-foreground text-right whitespace-nowrap" active={sort.key === "valor"} direction={sort.direction} onSort={() => toggle("valor")}>Valor Líquido</SortableTh>}
                      </tr>
                    </thead>
                    <tbody>
                      {sorted.map((r) => {
