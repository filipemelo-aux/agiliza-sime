...
@media print{body{padding:8px 12px;font-size:10px}@page{margin:6mm;size:A4 portrait}table{font-size:10px}th{padding:3px 5px;font-size:9px}td{padding:3px 5px;font-size:10px}.header{margin-bottom:10px;padding-bottom:8px}.summary-box{padding:6px 8px;gap:6px;margin-bottom:8px}.summary-item .value{font-size:12px}.summary-item .label{font-size:8px}.divider{margin:6px 0}.footer{margin-top:8px;padding-top:5px;font-size:8px}h2{font-size:12px;margin-bottom:4px}.section{margin-bottom:10px}.section-title{font-size:9px;margin-bottom:4px;padding-bottom:3px}.info-item label{font-size:8px}.info-item span{font-size:10px}.info-grid,.info-grid-3,.info-grid-4{gap:3px 16px}.company{font-size:14px}.company-sub,.company-addr{font-size:9px}.doc-title{font-size:18px}.doc-number{font-size:10px}}
</style></head><body>
