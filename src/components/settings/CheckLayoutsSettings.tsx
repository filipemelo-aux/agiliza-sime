...
const COORD_GROUPS: { title: string; fields: { base: string; label: string }[] }[] = [
  {
    ...
    fields: [
      ...
      { base: "data", label: "Data (linha única — usada se dia/mês/ano ficarem em 0)" },
      { base: "data_dia", label: "Data — dia" },
      { base: "data_mes", label: "Data — mês" },
      { base: "data_ano", label: "Data — ano" },
